...
def loop2():
    ...
    try:
        sleep(2)
        driver.find_element(By.XPATH,'//*[@id="sid2"]/div/form/div/input').send_keys(vidUrl)
        
        sleep(1)
        driver.find_element(By.XPATH,'//*[@id="sid2"]/div/form/div/div/button').click()
        
        sleep(5)
        driver.find_element(By.XPATH,'//*[@id="c2VuZE9nb2xsb3dlcnNfdGlrdG9r"]/div[1]/div/form/button').click()
        
        sleep(6)
        hearts = driver.find_element(By.XPATH,'//*[@id="c2VuZE9nb2xsb3dlcnNfdGlrdG9r"]/span').text.split()
...
def loop3():
    ...
    try:
        ...
        sleep(6)
        folls = driver.find_element(By.XPATH,'//*[@id="c2VuZF9mb2xsb3dlcnNfdGlrdG9r"]/span').text.split()
